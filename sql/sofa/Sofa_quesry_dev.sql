...
--NEW MIMIC *************
--220277	O2 saturation pulseoxymetry	2496691
--**223835	Inspired O2 Fraction	478576
--223770	O2 Saturation Pulseoxymetry Alarm - Low	200904
--223769	O2 Saturation Pulseoxymetry Alarm - High	199928
--223834	O2 Flow	196706
--226253	SpO2 Desat Limit	191054
--220224	Arterial O2 pressure	117958
--220235	Arterial CO2 Pressure	117944
--225698	TCO2 (calc) Arterial	117912
--223772	SvO2	59951
--220227	Arterial O2 Saturation	33520
--227287	O2 Flow (additional cannula)	18709
--225674	Mixed Venous O2% Sat	8567
...
--226063	Venous O2 Pressure	3909
--226062	Venous CO2 Pressure	3907
--227516	PO2 (Mixed Venous)	2178
...
,Pao2 as (
  select i.subject_id, i.icustay_id, i.seq, i.icustay_day_intime, i.icustay_day_outtime,
    ...
    from icustay_population i,
         mimic2v30.chartevents c
   where c.subject_id = i.subject_id
     --and c.icustay_id >48100
     --and c.icustay_id <49100
     and c.icustay_id = i.icustay_id
     and c.time >= i.icustay_day_intime
     and c.time < i.icustay_day_outtime
     and c.value1num is not null
...
-- OLD MIMIC ***
-- select * from MIMIC2v26.D_labitems where old_loinc_code = 50428;
-- 50428	PLT COUNT	BLOOD	HEMATOLOGY	26515-7	Platelets [#/volume] in Blood
-- NEW MIMIC ***
-- select * from MIMIC2v30.D_items where old_loinc_code like '%26515-7%';
-- NOTHING... THIS MEANS SOME TRANSFER WAS WRONG...
-- IN LABEVENTS
-- 51287		PLATELET COUNT	LAB	777-3	241586 
-- IN CHARTEVENTS
-- 227457		Platelet Count	METAVISION		120692
ss_raw_hema as (
  SELECT
    icud.subject_id,
    icud.icustay_id,
...
--OLD MIMIC *****
--580		Previous Weight	CHART		148498
--762		Admit Wt	CHART		44441
--1395		M-Ideal Body Wgt Kg	CHART		23
--1393		F-Ideal Body Wgt Kg	CHART		20
--NEW MIMIC *****
--226531		Admission Weight (lbs.)	METAVISION		43838
--224639		Daily Weight	METAVISION		41619
,
...
--MIMIC NEW
--**30042		Dobutamine	MED		40937
--**221653		Dobutamine	METAVISION		1354

--**30043		Dopamine	MED		108313
--**221662		Dopamine	METAVISION		5923

--**221289		Epinephrine	METAVISION		4542
--**30044		Epinephrine	MED		317

--**30047		Levophed	MED		14471
--**221906		Norepinephrine	METAVISION		47033

--**30119		Epinephrine-k	MED		50802
-- ?? METAVISION??

--30120		Levophed-k	MED		291917

--30306		Dobutamine Drip	MED		965
--?? meta ??

--30307		Dopamine Drip	MED		18995
-- ??

--30309		Epinephrine Drip	MED		75
-- ??
